...
public class _CourseStub extends org.omg.CORBA.portable.ObjectImpl implements CourseRegistrationSystem.Course
{
  ...
  public String enrollCourse (String id, String term, String department, String courseId, boolean udpCall, boolean swapOperation, boolean checkCrossEnrollLimit)
  {
            ...
            try {
                ...
                $out.write_boolean (swapOperation);
                $out.write_boolean (checkCrossEnrollLimit);
                $in = _invoke ($out);
                ...
                return enrollCourse (id, term, department, courseId, udpCall, swapOperation, checkCrossEnrollLimit        );
            } finally {
                _releaseReply ($in);
            }
  } // enrollCourse
  ...
  public String swapCourse (String id, String oldCourseId, String newCourseId, String term, String department)
  {
            ...
            try {
                ...
                return swapCourse (id, oldCourseId, newCourseId, term, department        );
            } finally {
                _releaseReply ($in);
            }
  } // swapCourse
